        ...
        <div>
            <section className="containerForMedicalSupport">
                ...
                <div>
                    <ol>
                        <li>
                            <h3>Обеспечение личной безопасности!</h3>
                            <span>Остановите автомобиль на обочине или крае проезжей части, так чтобы любой появившейся на дороге транспорт (выезжающий из-за поворота или из низины, имел достаточное время и расстояние чтобы увидеть вас и исключить столкновение.
Включите аварийную сигнализацию, наденьте светоотражающий жёлтый жилет и выставите знак аварийной остановки (предупреждение возможного наезда и столкновений от проезжающего рядом транспорта).
Основной подход — любые действия которые могут привести к новым жертвам или усугубить ситуацию — не разумны: «Лучше один труп, чем два!». Если опасности не заметит человек, пытающийся оказать помощь пострадавшим лицам находящимся в повреждённой машине, то ещё одним пострадавшим станет больше и, возможно, уже некому будет вызвать «скорую помощь» и (или) службу спасения. Всегда вначале оцените обстановку. Сейчас вы учитесь действовать продуманно, придерживаясь определённых алгоритмов, и отступление от них может стоить жизни не только пострадавшему, но и вам и другим спасателям.</span>
                        </li>
                        <li>
                            <h3>Оцените ситуацию на расстоянии,</h3>
                            <span> если не видите возможных угроз (резкое возгорание-взрыв, смещение объектов, падение линий электропередач, деревьев или других объектов и событий способных нанести вам вред) возьмите аптечку и огнетушитель (чтобы не расходовать драгоценное время на возвращение за ними при начале горения или определения необходимости срочной медицинской помощи) и подойдите ближе к повреждённому транспорту и пострадавшим.</span>
                        </li>
                        <li>
                            <h3>Оцените ситуацию вблизи,</h3>
                            <span> если не видите возможных угроз (резкое возгорание-взрыв, смещение объектов, падение линий электропередач, деревьев или других объектов и событий способных нанести вам вред). Приступайте к помощи.</span>
                        </li>
                        <li>
                            <h3>Если двигатель автомобиля продолжает работать,</h3>
                            <span>а пострадавший водитель не может заглушить двигатель, выключите двигатель, повернув ключ зажигания или нажав кнопку START/STOP.</span>
                        </li>
                        <li>
                            <h3>Определите количество пострадавших</h3>
                            <span> и их состояние. При наличии любого из факторов:</span>
                            <ul>
                                <li>пассажиров с жалобами на очень плохое самочувствие, боли</li>
                                <li>пассажиров бес сознания</li>
                                <li>пассажиров с явными признаками повреждений и ранения</li>
                                <li>пассажиров не способных самостоятельно выбраться</li>
                            </ul>
                            <p>Немедленно вызывайте скорую помощь и службу спасения на место ДТП (тел. 101 и 103, или
                                общий номер 112).</p>
                            <p>После того как вы дозвонились в службу скорой помощи или службу спасения вам необходимо
                                говорить быстро, но чётко.</p>
                            <p>Вам будут заданы следующие вопросы:</p>
                            <ul>
                                <li>количество пострадавших и их пол (Обязательно укажите количество пострадавших в ДТП,
                                    так как к каждому пострадавшему высылается отдельная бригада)
                                </li>
                                <li>возраст, если не знаете — указывайте приблизительно (ребёнок, подросток, взрослый,
                                    молодой, среднего возраста, пожилой)
                                </li>
                                <li>место ДТП: для городов адрес (улица и номер дома рядом или пересечение улиц), вне
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <p>Если больной без сознания, но дыхание и сердцебиение сохранены, то его как единое целое
                                ...
                                мероприятий.</p>
                            <p>Ваша цель — сохранить жизнь пострадавшего до прибытия медицинских работников!</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div>
                    <div>
                        ...
                        <div>
                            ...
                            <ul>
                                <li><span>венозное</span>— кровь тёмного цвета выделяется непрерывной струёй. Ваши
                                    действия — наложение тугой повязки на раневую поверхность используя стерильный
                                    медицинский бинт из аптечки
                                </li>
                                <li><span>артериальной</span>— наиболее опасный вид — отличается тем, что кровь
                                    ...
                                    аптечки — тугой повязки на 1,5 часа с фиксацией времени.
                                </li>
                                <li><span>капиллярное</span> кровотечение отмечается при значительном раневом дефекте
                                    кожного покрова. Кровоточит вся поверхность раны. Ваши действия — наложите тугую
                                    повязку стерильным бинтом из аптечки на рану или используйте стерильные салфетки.
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div>
                        ...
                        <div>
                            ...
                            <h3>Ваши действия:</h3>
                            <ul>
                                <li>обезбольте используя охлаждающий гипертермический пакет из аптечки</li>
                                <li>при наличии раны обработайте её (дезинфицирующими препаратами (Йод 5% из аптечки) по
                                    периметру раны без попадания внутрь раны) и укройте стерильным бинтом
                                </li>
                                <li>наложите шину или другой жёсткий плоский или цилиндрический предмет, зафиксировав за
                                    сустав выше и ниже места повреждения не стерильными бинтами из аптечки
                                </li>
                                <li>не пытайтесь вправить костные отломки!</li>
                            </ul>
                        </div>
                    </div>
                    <div>
                        ...
                        <div>
                            ...
                            <h3>Ваши действия:</h3>
                            <ul>
                                <li>при ожогах 1–2 степени как можно быстрее подставьте обожжённую поверхность под струю
                                    холодной воды, наложите чистую сухую повязку используя стерильный бинт, поверх ткани
                                    приложите холод — охлаждающий гипертермический пакет из аптечки
                                </li>
                                <li>при ожогах 3–4 степени накройте область ожога стерильным бинтом, поверх ткани
                                    наложите холод (охлаждающий гипертермический пакет из аптечки)
                                </li>
                                <li>при обширных ожогах уложите пострадавшего раненой поверхностью вверх, накройте ожог
                                    чистыми бинтами, поверх бинтов — холод(охлаждающий гипертермический пакет из
                                    аптечки), дайте обильное питьё, вызовите «Скорую помощь»
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div>
                        ...
                        <div>
                            ...
                            <h3>Ваши действия:</h3>
                            <ul>
                                <li>ударьте несколько раз раскрытой ладонью в межлопаточную область. В случае отсутствия
                                    ...
                                    надавите на подложечную область сложенными в замок руками
                                </li>
                                <li>если больной без сознания, переверните его на спину, попытайтесь рукой достать
                                    инородное тело и резко надавите на подложечную область
                                </li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <h3>Ваши действия:</h3>
                            <ul>
                                <li>проверьте наличие сознания, дыхания, сердцебиения</li>
                                <li>при их отсутствии начинайте реанимационные мероприятия по системе ABC</li>
                                <li>потеря сознания кратковременная (до трёх минут), сердцебиение и дыхание сохранены:
                                ...
                                <li>при потере сознания более трёх минут переверните больного на живот, очистите верхние
                                    дыхательные пути, приложите холод(охлаждающий гипертермический пакет из аптечки) к
                                    голове. Наблюдайте за дыханием, сердцебиением, срочно вызовите медицинскую помощь
                                </li>
                                <li>ПОМНИТЕ! Во всех случаях потери сознания нужна квалифицированная медицинская
                                    помощь
                                </li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <h3>Ваши действия:</h3>
                            <ul>
                                <li>поверните больного на бок</li>
                                <li>прижмите его плечи к полу</li>
                                <li>вставьте плотный валик из ткани, резины между коренными зубами</li>
                                <li>обеспечьте безопасность больного (высок риск травматизации), срочно вызовите
                                    медицинскую помощь
                                </li>
                            </ul>
                        </div>
                    ...
                    <div>
                        ...
                        <div>
                            <p>Внимание! Боль носит давящий, жгущий, режущий характер, располагается по центру груди или
                        ...
                        <h3>Ваши действия:</h3>
                        <ul>
                            <li>обеспечьте больному максимальный покой, доступ свежего воздуха. Срочно вызовите
                                медицинскую помощь
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <div>
                            ...
                            <p> Если боль вверху живота тупого, опоясывающего характера. Ваши действия: холод, голод,
                            ...
                            <p> ПОМНИТЕ! При болях в животе не следует без консультации врача принимать обезболивающие
                    ...
                    <div>
                        ...
                        <h3>Ваши действия:</h3>
                        <ul>
                            <li>положите холод на место укуса или инъекции</li>
                            <li>срочно обратитесь к врачу</li>
                        </ul>
                    </div>
                </div>
            </section>
